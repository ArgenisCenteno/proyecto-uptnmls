<div class="row">
    ...
    <div class="col-md-6 mt-4">
        ...
        {!! Form::select('personal', $personals->pluck('nombre', 'id'), $asignacion->personal_id, ['class' => 'form-control round']) !!}
    </div>

    <div class="col-md-6 mt-4">
        {!! Form::label('requerimiento', 'Requerimiento:', ['class' => 'bold']) !!}
        {!! Form::select('requerimiento', $requerimientos->pluck('id', 'id'), $asignacion->requerimiento_id, ['class' => 'form-control round']) !!}
    </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="cantidad[{{ $producto->id }}]" value="{{ $producto->cantidad }}" class="form-control  cantidad-producto" data-stock="{{$producto->producto->cantidad}}">
                    </td>
