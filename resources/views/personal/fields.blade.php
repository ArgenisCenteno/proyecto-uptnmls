<div class="row">
    ...
    <div class="form-group col-sm-12 col-md-6">
        ...
        {!! Form::text('telefono', null, ['class' => 'form-control round', 'required', 'id' => 'telefono']) !!}
    </div>

    <!-- RIF Field -->
    <div class="form-group col-sm-12 col-md-6">
        {!! Form::label('rif', 'RIF:', ['class' => 'bold']) !!}
        {!! Form::text('rif', null, ['class' => 'form-control round', 'required', 'id' => 'rif']) !!}
    </div>

    <!-- Dirección Field -->
    <div class="form-group col-sm-12 col-md-6">
        {!! Form::label('direccion', 'Dirección:', ['class' => 'bold']) !!}
        {!! Form::textarea('direccion', null, ['class' => 'form-control round', 'rows' => 3, 'required']) !!}
    </div>
    ...
    <div class="form-group col-sm-12 col-md-6">
        ...
        {!! Form::select('disponible', ['1' => 'Activo', '0' => 'Inactivo'], null, ['class' => 'form-control round', 'required']) !!}
    </div>
</div>
