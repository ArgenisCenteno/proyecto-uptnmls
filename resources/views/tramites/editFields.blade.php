@if($tramite->tipo != 'DEVOLUCIÓN DE PRODUCTOS')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="status_actual" value="{{strtoupper($tramite->estado) }}"
                    disabled>
            </div>
        </div>
        <div class="col-md-6">
...
@else
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="status_actual">Observación</label>
                <textarea class="form-control" name="descripcion" id="" required>
    ...
    <h3 class="mt-3 mb-4">Productos a Devolver</h3>
    <div class="table-responsive">
        <table class="table table-bordered">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($productos as $producto)
                    <tr>
                        <td>{{ $producto->productoAsignado->producto->nombre }}</td>
                        <td>{{ $producto->productoAsignado->producto->descripcion }}</td>
                        <td>{{ $producto->cantidad }}</td>
                    </tr>
                @endforeach
            </tbody>
